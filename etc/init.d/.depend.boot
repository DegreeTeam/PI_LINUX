TARGETS = fake-hwclock mountkernfs.sh hostname.sh udev keyboard-setup mountdevsubfs.sh checkroot.sh console-setup mountall.sh mountall-bootclean.sh mountnfs.sh mountnfs-bootclean.sh urandom networking alsa-utils x11-common kbd plymouth-log udev-mtab kmod mtab.sh bootmisc.sh procps checkroot-bootclean.sh checkfs.sh
