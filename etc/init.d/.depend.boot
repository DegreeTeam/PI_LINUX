TARGETS = fake-hwclock mountkernfs.sh hostname.sh udev keyboard-setup mountdevsubfs.sh checkroot.sh kmod mtab.sh checkroot-bootclean.sh console-setup mountall.sh mountall-bootclean.sh mountnfs.sh mountnfs-bootclean.sh networking urandom alsa-utils x11-common kbd plymouth-log udev-mtab bootmisc.sh procps checkfs.sh
